 ...
 * @api public
 */
exports.getDescendants = function*(departmentId,limit,cursor,conditionKey,conditionAdmin,conditionDisabled){
    var order = 'id asc'
    var conditons = {}
    var department = yield MiniDepartment.getById(departmentId)
    ...
    var childrenMembersList = yield helpers.simplePage(userModel, conditons, limit, cursor, order)
    return childrenMembersList
