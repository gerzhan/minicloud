...
var modelOnlineDevice = require("./online-device")
var modelEvent = require("./event") 
var md5 = require('md5')
...
exports.remove = function*(id) {
    yield deviceModel.find({
        id: id
    }).remove().coRun()
    yield modelOnlineDevice.removeAllByDeviceId(id)
    yield modelEvent.removeAllByDeviceId(id)
}
