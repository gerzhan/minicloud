...
HookFile.run()
     ...
     * @api public
     */
exports.getDownload301Url = function*(device, file, options) {
        var MiniFileDownload = require('./file-download').MiniFileDownload
        var miniFileDownload = new MiniFileDownload()
        return yield miniFileDownload.getDownload301Url(device, file, options)
    }
    /**
     ...
     * @api public
     */
exports.getThumbnail301Url = function*(device, file, options) {
        var MiniFileThumbnail = require('./file-thumbnail').MiniFileThumbnail
        var miniFileThumbnail = new MiniFileThumbnail()
        return yield miniFileThumbnail.getThumbnail301Url(device, file, options)
    }
    /**
     * Create file
     * @param {Object} device 
...
exports.move = function*(device, fromPath, toPath, options) {
     ...
     * @api public
     */
exports.listFolder = function*(device, file, cursor, limit) {
        var MiniFileList = require('./file-list').MiniFileList
        var miniFileList = new MiniFileList()
        return yield miniFileList.getList(device, file, cursor, limit)
    }
    /**
     * return file list
     ...
     * @api public
     */
exports.consoleFileList = function*(conditions, cursor, limit) {
    conditions.msg = 'console_files'
    var MiniFileList = require('./file-list').MiniFileList
    var miniFileList = new MiniFileList()
