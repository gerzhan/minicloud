...
var PATH_SEP = '/'
     ...
     * @api private
     */
var lowerPath = function(filePath) {
...
var recursiveCreateFolder = function*(userId, parentFile, subFolders) {
        ...
        if (!childFolderFile) {
            ...
            childFolderFile = yield fileModel.create({
                ...
                lower_path: lowerPath(childFolderPath),
                is_deleted: 0
            })
        }
...
var createFolder = function*(userId, filePath) {
    var file = yield getFileByPath(filePath)
    if (!file) {
