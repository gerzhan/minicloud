...
/**
 * Hook with department rename
 * @param departmentId newPath
 * @api public
 */
exports.renamePath = function*(departmentId,newPath) {
    var list = yield userDepartmentRelationModel.findAll({
        where: {
            department_id: departmentId
        }
    })
