...
exports.download = function*() {
        ...
        this.checkBody('path').isInt('missing required field.')
        if (this.errors) {
        ...
        this.statsCode = 301
        this.body = yield MiniFile.getDownload301Url(device, file)
    }
    /**
     *get file thumbnail
     * @api public
...
exports.thumbnail = function*() {
        ...
        this.statsCode = 301
        this.body = yield MiniFile.getThumbnail301Url(device, file, body.size)
    }
    /**
     *list folder
     * @api public
