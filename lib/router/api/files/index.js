...
exports.getMetadata = function*() {
        ...
        if (file.type === 0) {
            ...
            metadata.client_modified = (new Date(file.client_modified)).format("yyyy-MM-dd hh:mm:ss")
...
exports.delete = function*() {
    ...
    if (Object.prototype.toString.call(filePath) === '[object Array]') {
        for (var i = 0; i < filePath.length; i++) {
            ...
            yield MiniFile.fakeDeleteFile(userId, filePath[i], {
                device: device,
                ip: this.request.ip,
                path:filePath[i]
            })
    ...
    if (Object.prototype.toString.call(filePath) === '[object String]') {
        ...
        yield MiniFile.fakeDeleteFile(userId, filePath, {
            device: device,
            ip: this.request.ip,
            path:filePath
        })
