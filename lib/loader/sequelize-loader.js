...
SequelizeLoader.prototype.connect = function(cb) {
        ...
        var protocol = process.env.ORM_PROTOCOL || 'sqlite'
        ...
        dbConfig.pool['maxConnections'] = dbConfig.pool['maxConnections'] || 5
        dbConfig.pool['maxIdleTime'] = dbConfig.pool['maxIdleTime'] || 3000

        this.tablePrefix = dbConfig['table_prefix']
        global.tablePrefix = dbConfig['table_prefix']
