...
DBLoader.prototype.defineUserGroupRelationModel = function() {
     ...
     * @api private
     */
DBLoader.prototype.defineDepartmentModel = function() {
     ...
     * @api private
     */
DBLoader.prototype.defineUserDepartmentRelationModel = function() {
...
DBLoader.prototype.defineVersionMetaModel = function() {
     ...
     * @api private
     */
DBLoader.prototype.defineTagModel = function() {
...
DBLoader.prototype.defineFileTagRelationModel = function() {
...
DBLoader.prototype.defineEventModel = function() {
     ...
     * @api private
     */
DBLoader.prototype.defineDocNodeModel = function() {
     ...
     * @api private
     */
DBLoader.prototype.defineSearchNodeModel = function() {
     ...
     * @api private
     */
DBLoader.prototype.defineSearchFileModel = function() {
        if (this.oldVersion) {
     ...
     * @api private
     */
DBLoader.prototype.defineSearchBuildTaskModel = function() {
        if (this.oldVersion) {
     ...
     * @api private
     */
DBLoader.prototype.defineStoreNodeModel = function() {
     ...
     * @api private
     */
DBLoader.prototype.defineStoreBreakFileModel = function() {
        if (this.oldVersion) {
     ...
     * @api private
     */
DBLoader.prototype.defineStoreReplicateTaskModel = function() {
        if (this.oldVersion) {
