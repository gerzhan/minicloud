...
module.exports = {
    ...
    database: process.env.SEQ_DB || 'minicloud_test',
    ...
    mssql: {
        database: process.env.SEQ_MSSQL_DB || process.env.SEQ_DB || (function() {
            var db = 'minicloud-test-' + ~~(Math.random() * 100)
        ...
        host: process.env.SEQ_MSSQL_HOST || process.env.SEQ_HOST || 'mssql.minicloud.io',
    ...
    mysql: {
        database: process.env.SEQ_MYSQL_DB || process.env.SEQ_DB || 'minicloud_test',
        username: process.env.SEQ_MYSQL_USER || process.env.SEQ_USER || 'root',
        password: process.env.SEQ_MYSQL_PW || process.env.SEQ_PW || '123456',
    ...
    postgres: {
        database: process.env.SEQ_PG_DB || process.env.SEQ_DB || 'minicloud_test',
