...
describe(protocol + ' groups/users/add', function() {
    ...
    it(protocol + ' groups/users/add 200', function*(done) {
        var res = yield request(app)
            .post('/api/v1/groups/users/add')
            .type('json')
            .set({
    ...
    it(protocol + ' groups/users/add socket.io  200', function*(done) {
    ...
    it(protocol + ' groups/users/add 401', function*(done) {
        var res = yield request(app)
            .post('/api/v1/groups/users/add')
            .type('json')
            .set({
    ...
    it(protocol + ' groups/users/add 409 group_not_exist', function*(done) {
        var res = yield request(app)
            .post('/api/v1/groups/users/add')
            .type('json')
            .set({
    ...
    it(protocol + ' groups/users/add 409 user_not_exist', function*(done) {
        var res = yield request(app)
            .post('/api/v1/groups/users/add')
            .type('json')
            .set({
    ...
    it(protocol + ' groups/users/add 400', function*(done) {
        var res = yield request(app)
            .post('/api/v1/groups/users/add')
            .type('json')
            .set({
