...
describe(protocol + ' files/copy', function() {
    this.timeout(10000)
    var app = null
    var MiniUser = null
    var user = null
    ...
    it(protocol + ' files/copy 400', function*(done) {
        var res = yield request(app)
    ...
    it(protocol + ' files/copy 401', function*(done) {
        var res = yield request(app)
            .post('/api/v1/files/copy')
            .type('json')
            .set({
    ...
    it(protocol + ' files/copy 200 file', function*(done) {
        var res = yield request(app)
            .post('/api/v1/files/copy')
            .type('json')
            .set({
            ...
            .expect(200)
            .end()
        res.body.path_lower.should.equal('/1/light/1.doc')
        res.body.hash.should.equal(version.hash)
        done()
    })
    it(protocol + ' files/copy 200 file autorename (1)', function*(done) {
        var res = yield request(app)
            .post('/api/v1/files/copy')
            .type('json')
            .set({
            ...
            .expect(200)
            .end()
        res.body.path_lower.should.equal('/1/light/1 (1).doc')
        res.body.hash.should.equal(version.hash)
        done()
    })
    it(protocol + ' files/copy 200 folder', function*(done) {
        var res = yield request(app)
            .post('/api/v1/files/copy')
            .type('json')
            .set({
            ...
            .send({
                from_path: '/LIGht/好/123',
                to_path: '/ab/cd/123'
            })
            .expect(200)
            .end()
        res.body.path_lower.should.equal('/1/ab/cd/123')
        done()
    })
    it(protocol + ' files/copy 200 folder autorename (1)', function*(done) {
        var res = yield request(app)
            .post('/api/v1/files/copy')
            .type('json')
            .set({
            ...
            .expect(200)
            .end()
        res.body.path_lower.should.equal('/1/ab/cd/123 (1)')
        done()
    })
})
