...
function getBearerToken (done) {
  ...
  var methodsUsed = (headerToken!=='' && headerToken !== undefined) + (getToken !== undefined) +
    (postToken !== undefined);
...
function checkToken (done) {
  ...
  this.model.getAccessToken(this.bearerToken, function (err, token) {
    ...
    self.req.device = token.device ? token.device : { id: token.userId };
    console.log(self.req.device)
    done();
  });
}
